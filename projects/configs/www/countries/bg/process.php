...
{
	$new_config=fopen("../../final/routers/bg/$HOSTNAME-$router.conf","w");
...
if ($_REQUEST["template"]=="meraki_mx")
{
	$new_config_sw=fopen("../../final/switches/bg/$SW_HOSTNAME","w");
	...
	{
		$new_config_sw2=fopen("../../final/switches/bg/$SW2_HOSTNAME","w");
		$template=file("../templates/switch/$SWNAME");
		#temporary
...
{
	$szyfr_path_final="../../final/szyfr/bg/";
