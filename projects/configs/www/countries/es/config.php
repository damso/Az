...
<div style="float: left; margin-right: 30px;"><b>ES</b></div>
<div class="container">
	...
	<div class="row">
		<div class="col-xs-6 col-md-4">
			<div class="form-group">
				...
				<div class="radio">
					<label class="radio-inline"><input type="radio" name="template" value="meraki_mx" id="meraki_mx" onclick="merakidisable();" required >Cisco Meraki</label>
				</div>
			</div>
		</div>
		<div class="col-xs-6 col-md-4">	
			...
			<div class="radio">
				...
				<label class="radio-inline">
					<input type="radio" name="brand" value="latag" id="latag" > LaTag</label>
			</div>
			<br />
			<caption><b>Switch Model:</b></caption>
			<div class="radio">
				<label class="radio-inline">
					<input type="radio" name="model" value="cisco" id="cisco" required checked >Cisco 2960Plus</label>
				<label class="radio-inline">
					<input type="radio" name="model" value="dell" id="dell" > Dell 3548</label>
				 <label class="radio-inline">
...
<div class="container-fluid">
	...
	<div class="form-group form-group-sm">
		<div class="col-md-3 col-xs-6" style="text-align: right;"><label class="control-label">MPK number:</label></div>
		<div class="cold-md-9 col-xs-6">
