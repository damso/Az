...
if ($_REQUEST["model"]=="cisco")
{
    ...
    if ($_REQUEST["brand"]=="sbx_ph")
    {
	$SWNAME="switchmerakisbxph.cfg";
    }
    if ($_REQUEST["brand"]=="latag")
    {
	$SWNAME="switchmerakilatag.cfg";
    }
}
...
$SW_HOSTNAME=$swtmp."_SW1_".$SAP."_".$swoth;
$SW2_HOSTNAME=$swtmp."_SW2_".$SAP."_".$swoth;
unset($swtmp);
unset($swoth);
...
{
	$new_config=fopen("../../final/routers/es/$HOSTNAME-$router.conf","w");
...
if ($_REQUEST["template"]=="meraki_mx")
{
	$new_config_sw=fopen("../../final/switches/es/$SW_HOSTNAME","w");
	...
	{
		$new_config_sw2=fopen("../../final/switches/es/$SW2_HOSTNAME","w");
		$template=file("../templates/switch/$SWNAME");
		#temporary
...
{
	$szyfr_path_final="../../final/szyfr/es/";
