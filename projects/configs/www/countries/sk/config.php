...
<div style="float: left; margin-right: 30px;"><b>SK</b></div>
<div class="container">
		...
		<div class="col-xs-6 col-md-4">
			<div class="form-group">
				...
				<div class="radio">
					...
					<label class="radio-inline"><input type="radio" name="template" value="SK_896LTEADSL_VDSL" id="SK_896LTEADSL_VDSL" >Cisco 896LTE_(A/VDSL)</label>
					<label class="radio-inline"><input type="radio" name="template" value="C1116LTE" id="C1116LTE" checked="checked">Cisco C1116LTE</label>
				</div>
			</div>
		</div>
		<div class="col-xs-6 col-md-4">	
...
<div class="container-fluid">
	...
	<div class="form-group form-group-sm">
		...
		<div class="cold-md-9 col-xs-6">
			<input class="form-control" type="text" name="tunnel4_ip" size="15" style="width: 150px;"/>
		</div>
	</div>
