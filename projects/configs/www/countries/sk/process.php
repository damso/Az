...
$FXS0=$_REQUEST["fxs0"];
$FXS1=$_REQUEST["fxs1"];
$new_config=fopen("../../final/routers/sk/$HOSTNAME-$router.conf","w");
...
$new_config_sw=fopen("../../final/switches/sk/$SW_HOSTNAME","w");
...
{
	$szyfr_path_final="../../final/szyfr/sk/";
