...
{
    $SWNAME="switchmerakicz.cfg";
}
else if ($_REQUEST["model"]=="dell")
{
    $SWNAME="dellmerakicz.cfg";
}
else if ($_REQUEST["model"]=="cbs")
{
    $SWNAME="cbsswitchcz.cfg";
}
...
#Routery bez SitB
if ($_REQUEST["template"]=="886VAG" || $_REQUEST["template"]=="896LTEADSL" || $_REQUEST["template"]=="896LTE" || $_REQUEST["template"]=="C1116LTEADSL" || $_REQUEST["template"]=="C1116LTE")
{
	$new_config=fopen("../../final/routers/cz/$HOSTNAME-$router.conf","w");
...
#C1116LTE z SitB
if ($_REQUEST["template"]=="C1116LTE-SitB")
{
        $new_config=fopen("../../final/routers/cz/$HOSTNAME-$router.conf","w");
        $template=file("templates/C1116LTE-SitB.cfg");
        #temporary
        echo "<h1>Config for Router:</h1>";
         foreach ($template as $k=>$v)
                        {
...
#SW1 Meraki
if ($_REQUEST["template"]=="meraki_mx" || $_REQUEST["template"]=="C1116LTE-SitB")
{
	$new_config_sw=fopen("../../final/switches/cz/$SW_HOSTNAME","w");
	$template=file("../templates/switch/$SWNAME");
	#temporary
	echo "<h1>Config for Switch1:</h1>";
	 foreach ($template as $k=>$v)
			{
	...
	{
		$new_config_sw2=fopen("../../final/switches/cz/$SW2_HOSTNAME","w");
		$template=file("../templates/switch/$SWNAME");
		#temporary
...
{
	$new_config_sw=fopen("../../final/switches/cz/$SW_HOSTNAME","w");
	$template=file("../templates/switch/switch_cz.cfg");
	#temporary
	echo "<h1>Config for Switch1:</h1>";
	 foreach ($template as $k=>$v)
		{
...
{
	$szyfr_path_final="../../final/szyfr/cz/";
