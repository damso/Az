...
{
	$new_config=fopen("../../final/routers/hu/$HOSTNAME-$router.conf","w");
...
if ($_REQUEST["template"]=="meraki_mx")
{
	$new_config_sw=fopen("../../final/switches/hu/$SW_HOSTNAME","w");
	...
	{
		$new_config_sw2=fopen("../../final/switches/hu/$SW2_HOSTNAME","w");
		$template=file("../templates/switch/$SWNAME");
		#temporary
...
{
	$new_config_sw=fopen("../../final/switches/hu/$SW_HOSTNAME","w");
	$template=file("../templates/switch/switchhu.cfg");
	#temporary
	echo "<h1>Config for Switch:</h1>";
	 foreach ($template as $k=>$v)
			{
...
{
	$szyfr_path_final="../../final/szyfr/hu/";
